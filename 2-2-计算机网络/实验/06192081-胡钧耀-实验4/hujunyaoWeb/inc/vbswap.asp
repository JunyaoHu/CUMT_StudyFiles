...
Private Sub Ok3w_Article_bList01(ClassID,PageSize)
	...
	Do While Not Rs.Eof And Not Page.Eof
		...
		If Rs("TitleURL")="" Then
			...
			End If
		Response.Write("<li><div class=hangju02 style=""FLOAT:left""><A href=""" & TitleURL & """ target=_blank><div id=div1><IMG height=""60px"" src=""" & Rs("PicFile") & """ width=""80px""></div></A></div>" & Format_TitleURL(HTML_Article_Path,Rs("ID"),Rs("Title"),Rs("TitleColor"),Rs("TitleURL"),50) &"")
		Response.Write("<br/><span class=""hangju01"">" & Format_Time(Rs("AddTime"),2) & "&nbsp;|&nbsp;"& Rs("Hits")&"次阅读</span></li>")
...
Private Sub Ok3w_Article_PreNext(ClassID,ID)
	...
	If oRs.Eof And oRs.bof Then
		...
		Else
			Response.Write(Format_TitleURL(HTML_Article_Path,oRs("ID"),"&nbsp;前：" & oRs("Title"),oRs("TitleColor"),oRs("TitleURL"),50))
	End If
	Response.Write("</td>")
	Response.Write("</tr>")
	...
	If oRs.Eof And oRs.bof Then
		...
		Else
			Response.Write(Format_TitleURL(HTML_Article_Path,oRs("ID"),"&nbsp;后：" & oRs("Title"),oRs("TitleColor"),oRs("TitleURL"),50))
	End If
	Response.Write("</td>")
	Response.Write("</tr>")
...
Private Sub Ok3w_Article_IndexTop()
	...
	If Rs.Eof And Rs.Bof Then
	Else
		Response.Write("<A href=""" & Page_URL(ChannelID, "",Rs("ID")) & """>" & Rs("Title") & "</A>")
	End If
	Rs.Close
End Sub
